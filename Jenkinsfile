            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'github-credentials', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                        ...
                        //ssh "git remote set-url origin https://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@github.com/${USER}/java-maven-app.git"
                        ssh "git remote set-url origin git@github.com:${USER}:${PASS}/java-maven-app.git"
                        sh 'git add .'
